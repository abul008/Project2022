...
export const Detailed: React.FC = () => {
  ...
  const [detalieddata , setDetalieddata]= useState<PropTypes[]>()
            ...
            <div className="detalied-image-to-show">
              <div className="detalied-image-list-cantrol">
                ...
                <div  className="change-image-icon-svg">
                  <button 
                    disabled={headimg === 0 ? true : false}  
                    onClick={() => setHeadimg(headimg - 1)}
                    className="rotate-image-list list-left">
                    <SvgTransform />
                  </button>
                  <button 
                    disabled={headimg === filelength ? true : false}
                    onClick={ () => setHeadimg(headimg + 1)}
                    className="rotate-image-list list-right">
                    <SvgTransform />
                  </button>
                </div>
              </div>
              <div  className="detalied-all-image" >
                {
                  detalieddata ? detalieddata[0].file.map( (datas, index) => {
                    return (
                      <img 
                        onClick={ () => setHeadimg(index)} 
                        key={datas} 
                        src={`${datas}`} alt="bookfoto"
                        className="detalied-image-small" >
                      </img>
                    )
                  } 
                 ) : undefined
              ...
              <table>
                <tbody>
                  <tr>
                    ...
                    <td>
                      {detalieddata ? detalieddata[0].autor : undefined}
                    </td>  
                  </tr>
                    <tr>
                      <td>
                      ...
                      <td>
                        {detalieddata ? detalieddata[0].language : undefined}
                      </td>  
                    </tr>
                    <tr>
                      <td>
                      ...
                      <td>
                        {detalieddata ? detalieddata[0].publisher : undefined}
                      </td>  
                    </tr>
                    <tr>
                      <td>
                      ...
                      <td>
                        {detalieddata ? detalieddata[0].pages : undefined}
                      </td>  
                    </tr>  
                    <tr>
                      <td>
                        {i18next.t('Publicationdate')}
                      </td>  
                      <td>
                        {detalieddata ? detalieddata[0].date : undefined}
                      </td>  
                    </tr>
                    <tr>
                      <td>
                      ...
                      <td>
                        {detalieddata ? detalieddata[0].weight : undefined}
                      </td>  
                    </tr>  
                  </tbody>
                </table>
